...
MESSAGES = {
    'zh': {
        ...
        'Press Ctrl+Enter to send message': '按 Ctrl/Cmd+Enter 发送消息',
        'welcome_message': '哈啰！我是**爱派**，您的智能任务小管家!\n请允许我隆重介绍团队其它成员：\n- 图灵：宇宙最强人工智能，复杂任务分析和规划\n- BB-8: 宇宙最强机器人，负责执行任务\n\n温馨提示：打开菜单栏"**帮助**"链接，可以联系**爱派**官方和加入群聊。',
    ...
    'en': {
        ...
        'End': 'End',
        'Send': 'Send',
        'AIPY - Your AI Assistant': '🐙 AIPY - Your AI Assistant 🐂 🐎',
